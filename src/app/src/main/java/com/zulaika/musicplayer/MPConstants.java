...
public class MPConstants {
    public static final String PACKAGE_NAME = "com.zulaika.musicplayer";

    public static final int PERMISSION_READ_STORAGE = 1009;
    public static final long TWENTY_SECONDS_IN_MS = 20000;

    public static final String MEDIA_SESSION_TAG = "com.zulaika.musicplayer.MediaSession";

    public static final int NOTIFICATION_ID = 101;
    public static final String PLAY_PAUSE_ACTION = "com.zulaika.musicplayer.PLAYPAUSE";
    public static final String NEXT_ACTION = "com.zulaika.musicplayer.NEXT";
    public static final String PREV_ACTION = "com.zulaika.musicplayer.PREV";
    public static final String CHANNEL_ID = "com.zulaika.musicplayer.CHANNEL_ID";
